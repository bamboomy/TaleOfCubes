...
import static org.bamboomy.taleofcubes.game.BeastRenderer.FLOAT_SIZE_BYTES;
...
class Cube {
    ...
    Cube(MotionListener motionListener, BeastActivity beastActivity, boolean chooseUnchosen) {

        for (int i = 0; i < sides.length; i++) {

            sides[i] = new Side(beastActivity, chooseUnchosen);
        }
