...
public class Pictures {
    ...
    public static Bitmap decodeSampledBitmapFromResource(
            int resId, int reqWidth, int reqHeight, BeastActivity mContext) {
    ...
    static Bitmap getUnchoosenPicture(BeastActivity beastActivity) {
        ...
        Bitmap temp = decodeSampledBitmapFromResource(
                prentz[randomImage], 200, 200, beastActivity);
