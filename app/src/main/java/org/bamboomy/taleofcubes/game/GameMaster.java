...
public class GameMaster {
        ...
        if (numberShown == Tupple.MAX) {
            ...
            if (checkWin()) {
                ...
                if (Tupple.isAllSolved()) {
                    ...
                    Intent myIntent = new Intent(BeastActivity.INSTANCE, MainActivity.class);

                    BeastActivity.INSTANCE.startActivity(myIntent);

                    BeastActivity.INSTANCE.finish();
                }
    ...
    /*
    JsonObject getMetricsAsJson() {

        JsonObject json = new JsonObject();
        json.addProperty("taps", taps);
        json.addProperty("time", rawTime);
    ...
    boolean showColor() {
        ...
        return taps >= 100 && !isOneTupleSolved;
    }
}
