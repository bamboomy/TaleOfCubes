...
import static org.bamboomy.taleofcubes.game.TutorialManager.COLOR_TUTORIAL_FINISHED;
...
public class BeastRenderer implements GLSurfaceView.Renderer {
    ...
    private BeastActivity activity;
    ...
    BeastRenderer(MotionListener motionListener, BeastActivity beastActivity) {

        beast = new Beast(motionListener, beastActivity);

        Matrix.setIdentityM(mRotMatrix, 0);

        this.activity = beastActivity;
